                    ...
                    case "DeleteData":
                        {
                            ...
                            try
                            {
                                ...
                                Parent_CM.CommandText = string.Format(@"Proc_Attendance_RegOvertime_Del_Web_FromH3OA");
                    ...
                    case "InsertData":
                        {
                            ...
                            try
                            {
                                ...
                                stockschema.Add(new H3.BizBus.ItemSchema("RegOvertimeType", "加班类型", BizDataType.String, 200, null));
                                ...
                                detailsSchema.Add(new H3.BizBus.ItemSchema("RegOvertimeHour", "加班小时", BizDataType.Double, 200, null));
                                detailsSchema.Add(new H3.BizBus.ItemSchema("DetailRemark", "备注", BizDataType.String, 1000, null));
                                ...
                                for (int i = 0; i < detailsDatasCount; i++)
                                {
                                    ...
                                    cm.CommandText = string.Format(@"Proc_Attendance_RegOvertime_New_Web_FromH3OA");
                                    ...
                                    cm.Parameters.AddWithValue("@DateType", billBizStructure["RegOvertimeType"]);
                                    cm.Parameters.AddWithValue("@IsAstrideDepartmentRegOvertime", "0");
                                    cm.Parameters.AddWithValue("@RegOvertimeHour", detailsDatas[i]["RegOvertimeHour"]);
                                    cm.Parameters.AddWithValue("@Remark", detailsDatas[i]["DetailRemark"].ToString() + "来自新H3补卡单");                                    
